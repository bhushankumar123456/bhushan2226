...
public class Anxiety_moderate {
    public static void main(String[] args) {
        ...
        try {
            ...
            driver.findElement(By.xpath("/html/body/div[2]/nav/div/div[1]/ul/li[2]/a/span")).click();
            ...
            Thread.sleep(1500);
            //1st question
            WebElement question1ButtonInIframe = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/bod"
            		+ "y/div/div[1]/div/div[4]/div[1]/div[3]/div/div")));
            ...
            Thread.sleep(1500);
            //2nd question
            WebElement question2ButtonInIframe = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/"
            		+ "div/div[1]/div/div[4]/div[1]/div[3]/div/div")));
            js.executeScript("arguments[0].scrollIntoView(true);", question2ButtonInIframe);
            question2ButtonInIframe.click();
            System.out.println("Clicked 3rd option button inside sychart.");
            Thread.sleep(1500);
            //3rd question
            WebElement question3ButtonInIframe = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/"
            		+ "div/div[1]/div/div[4]/div[1]/div[3]/div/div")));
            ...
            Thread.sleep(1500);
            //4th question
            WebElement question4ButtonInIframe = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/"
            		+ "div/div[1]/div/div[4]/div[1]/div[3]/div/div")));
            ...
            Thread.sleep(1500);
            //5th question
            WebElement question5ButtonInIframe = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body"
            		+ "/div/div[1]/div/div[4]/div[1]/button[3]")));
            js.executeScript("arguments[0].scrollIntoView(true);", question5ButtonInIframe);
            question5ButtonInIframe.click();
            System.out.println("Clicked 3rd option button inside sychart.");
            Thread.sleep(1500);
            //6th question
            WebElement question6ButtonInIframe = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body"
            		+ "/div/div[1]/div/div[4]/div[1]/button[3]")));
            ...
            Thread.sleep(1500);
            //7th question
            WebElement question7ButtonInIframe = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/"
            		+ "div/div[1]/div/div[4]/div[1]/button[3]")));
            ...
            Thread.sleep(1500);
            //8th question
            WebElement question8ButtonInIframe = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/"
            		+ "div/div[1]/div/div[4]/div[1]/button[3]")));
